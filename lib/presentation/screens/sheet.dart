...
import 'package:vehicle_consumption_calculator/domain/repository/export.dart';
...
void showConsumptionSheet(context, WidgetRef ref, color, height, translates) {
  ref.watch(dataBaseStateProvider).loadSavedData(ref);
...
class ConsumptionSheetState extends ConsumerState<ConsumptionSheet> {
  void deleteItem(int index, WidgetRef ref) {
    ref.watch(dataBaseStateProvider).deleteSavedData(index, ref);
    setState(() {});
  }
